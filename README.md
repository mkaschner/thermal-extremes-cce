...
See [CITATION.cff](CITATION.cff). Once the repository is archived on Zenodo, add
the DOI here and in the manuscript's data/code availability statement:
...
> (v1.0.0). Zenodo. https://doi.org/10.5281/zenodo.XXXXXXX
